...
const ALL_PERMISSIONS = [
  ...
  // Procurement
  {
    ...
    module: 'Procurement',
    action: 'view',
    description: 'عرض طلبات وأوامر الشراء',
  },
  {
    name: 'edit:procurement',
    module: 'Procurement',
    action: 'edit',
    description: 'إنشاء وتعديل طلبات الشراء',
  },
  {
    name: 'approve:po',
    module: 'Procurement',
    action: 'approve',
    description: 'اعتماد أوامر الشراء',
  },
  {
    name: 'approve:pr',
    module: 'Procurement',
    action: 'approve',
    description: 'اعتماد طلبات الشراء',
  },
  // Inventory
  {
    name: 'view:inventory',
  ...
  },
  {
    ...
    module: 'Inventory',
    action: 'edit',
    description: 'تحديث المخزون والحركات',
  },
  // Vendors
  {
    name: 'view:vendors',
  ...
  // Rigs
  {
    ...
    module: 'Rigs',
    action: 'view',
    description: 'عرض الحفارات والمعدات',
  },
  {
    name: 'edit:rigs',
    module: 'Rigs',
    action: 'edit',
    description: 'إدارة الحفارات والمعدات',
  },
  // Timesheets
  {
    ...
    module: 'Timesheets',
    action: 'view',
    description: 'عرض سجلات الوقت',
  },
  {
    name: 'edit:timesheets',
    module: 'Timesheets',
    action: 'edit',
    description: 'إدخال وتعديل سجلات الوقت',
  },
  // HR
  {
    name: 'view:hr',
    module: 'HR',
    action: 'view',
    description: 'عرض بيانات الموارد البشرية',
  },
  {
    name: 'edit:hr',
    module: 'HR',
    action: 'edit',
    description: 'تعديل بيانات الموارد البشرية',
  },
  // Users & Roles
  {
    name: 'manage:users',
  ...
  },
  {
    ...
    module: 'Finance',
    action: 'edit',
    description: 'إدخال وتعديل البيانات المالية',
  },
  {
    name: 'approve:finance',
    module: 'Finance',
    action: 'approve',
    description: 'اعتماد المعاملات المالية',
  },
  // Reports
  {
    name: 'view:reports',
  ...
  // Assets
  {
    ...
    module: 'Assets',
    action: 'view',
    description: 'عرض الأصول الثابتة',
  },
  {
    name: 'edit:assets',
    module: 'Assets',
  ...
  // HSE
  {
    ...
    module: 'HSE',
    action: 'view',
    description: 'عرض تقارير الصحة والسلامة',
  },
  {
    name: 'edit:hse',
    module: 'HSE',
    action: 'edit',
    description: 'إدخال بيانات الصحة والسلامة',
  },
  // Recruitment
  {
  ...
  },
  {
    ...
    module: 'Recruitment',
    action: 'manage',
    description: 'إدارة عملية التوظيف',
  },
  // Maintenance
  {
    ...
    module: 'Maintenance',
    action: 'view',
    description: 'عرض أوامر الصيانة',
  },
  {
    name: 'edit:maintenance',
    module: 'Maintenance',
    action: 'edit',
    description: 'إنشاء وتعديل أوامر الصيانة',
  },
  // Audit
  {
    name: 'view:audit',
  ...
  // Vendor Portal
  {
    name: 'view:vendor_portal',
    module: 'Vendor',
    action: 'view',
    description: 'الوصول لبوابة الموردين',
  },
  {
    name: 'submit:vendor_quotation',
    module: 'Vendor',
    action: 'submit',
    description: 'تقديم عروض أسعار',
  },
];
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  Employee: ['view:dashboard', 'view:timesheets', 'edit:timesheets'],
  ...
  Vendor: ['view:vendor_portal', 'submit:vendor_quotation'],
};
...
export class SeederService implements OnApplicationBootstrap {
  ...
  private async seedRoles(
    permMap: Map<string, Types.ObjectId>,
    ...
    for (const roleDef of SYSTEM_ROLES) {
      ...
      if (!role) {
        ...
        this.logger.debug(
          `  Created role: ${roleDef.name} (${permIds.length} permissions)`,
        );
      } else {
  ...
  private async seedSuperAdmin(roleMap: Map<string, Types.ObjectId>) {
    ...
    this.logger.log(
      `  🔑 Default credentials → username: superadmin | password: ${defaultPassword}`,
    );
  }
}
